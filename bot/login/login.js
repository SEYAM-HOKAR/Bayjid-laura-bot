// set bash title
process.stdout.write("\x1b]2;Goat Bot V2 - remodified by BaYjid\x1b\x5c");
...
const author = "Remodified by BaYjid with ♡";
const srcUrl = "Source code: https://github.com/BAYJID-00/XASS-BOT-404.git";
...
async function getAppStateFromEmail(
  ...
  try {
    ...
    const loginMbasic = require(process.env.NODE_ENV === "development"
      ? "./loginMbasic.dev.js"
      : "./loginMbasic.js");
